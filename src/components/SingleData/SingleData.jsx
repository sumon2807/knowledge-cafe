...
const SingleData = ({info, handleReadTime, handleBookMarkTitle, handleWatchTime}) => {
                ...
                <div className="card-body">
                    <div className='flex justify-between items-center'>
                        ...
                        <div className="bookmark flex">
                            ...
                            <span onClick={()=>handleWatchTime(info,info.id)}>
                            <button onClick={()=>handleBookMarkTitle(blog_title)}>
